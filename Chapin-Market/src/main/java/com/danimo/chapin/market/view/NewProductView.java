...
public class NewProductView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 390, 200, 60));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (descr_producto_txt.getText().isEmpty() || name_producto_txt.getText().isEmpty() || nombre.equals("@") || precio.equals(-1.0)) {
            ...
            productoDaoImpl.insertar(new Producto(nombre, precio, descripcion));
        }
